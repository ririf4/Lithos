...
namespace Lithos {
    ...
    struct LITHOS_API TransitionConfig {
        ...
        explicit TransitionConfig(AnimatableProperty prop)
            : property(prop) {}
         ...
         */
        TransitionConfig& SetDuration(float dur) {
            duration = dur;
            return *this;
        }
    ...
    struct LITHOS_API ActiveTransition {
        ...
        ActiveTransition(AnimatableProperty prop,
    ...
    /**
     * @brief Transition manager attached to each Node
     *
    ...
    public:
         ...
         */
        void OnPropertyChange(Node* node,
                            AnimatableProperty property,
         ...
         */
        bool Update(Node* node, std::chrono::steady_clock::time_point currentTime);
    ...
    private:
         ...
         */
        PropertyValue GetCurrentValue(Node* node, AnimatableProperty property);

        /**
         * @brief Applies a value to a property on a node
         * @param node Node to apply value to
         * @param property Property to set
         * @param value Value to apply
         * @param skipTransition If true, bypasses transition system
         */
        void ApplyValue(Node* node,
                       AnimatableProperty property,
