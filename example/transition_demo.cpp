...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    fadeBox->SetPosition(50, 150)
           .SetSize(100, 100)
           .SetBackgroundColor(Color::LRGB(100, 150, 255))
           .SetBorderRadius(10)
    ...
    fadeInBtn->SetPosition(170, 150)
             .SetSize(120, 40)
             .SetNormalColor(Color::LRGB(70, 180, 100))
    ...
    fadeOutBtn->SetPosition(170, 200)
              .SetSize(120, 40)
              .SetNormalColor(Color::LRGB(255, 100, 100))
    ...
    colorBox->SetPosition(50, 310)
            .SetSize(100, 100)
            .SetBackgroundColor(Color::LRGB(255, 100, 100))
            .SetBorderRadius(10)
    ...
    greenBtn->SetPosition(260, 310)
            .SetSize(80, 35)
            .SetNormalColor(Color::LRGB(100, 255, 100));
    ...
    blueBtn->SetPosition(350, 310)
           .SetSize(80, 35)
           .SetNormalColor(Color::LRGB(100, 150, 255));
    ...
    purpleBtn->SetPosition(170, 355)
             .SetSize(80, 35)
             .SetNormalColor(Color::LRGB(200, 100, 255));
    ...
    sizeBox->SetPosition(430, 150)
           .SetSize(80, 80)
           .SetBackgroundColor(Color::LRGB(255, 180, 100))
           .SetBorderRadius(15)
    ...
    smallBtn->SetPosition(530, 150)
            .SetSize(100, 35)
            .SetNormalColor(Color::LRGB(150, 150, 200));
    ...
    multiTitle->SetPosition(430, 310)
              .SetFontSize(20)
              .SetFontWeight(FontWeight::SemiBold)
              .SetTextColor(Color::LRGB(70, 70, 90));
    ...
    multiBox->SetPosition(430, 340)
            .SetSize(90, 90)
            .SetBackgroundColor(Color::LRGB(180, 100, 200))
            .SetBorderRadius(10)
            .SetOpacity(1.0f)
    ...
    transformBtn->SetPosition(540, 350)
                .SetSize(140, 50)
                .SetNormalColor(Color::LRGB(255, 150, 80))
